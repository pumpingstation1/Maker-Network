...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('general_task_skills', (
            ...
            ('from_task', models.ForeignKey(orm['general.task'], null=False)),
            ('to_task', models.ForeignKey(orm['general.task'], null=False))
        ))
        db.create_unique('general_task_skills', ['from_task_id', 'to_task_id'])
        ...
        db.create_unique('general_task_resources', ['from_task_id', 'to_task_id'])
    ...
    models = {
        ...
        'general.task': {
            ...
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'resources_rel_+'", 'null': 'True', 'to': "orm['general.Task']"}),
            'skills': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'skills_rel_+'", 'null': 'True', 'to': "orm['general.Task']"}),
