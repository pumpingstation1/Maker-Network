...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field wait_on on 'Task'
        db.create_table('general_task_wait_on', (
        ...
        db.create_unique('general_task_wait_on', ['from_task_id', 'to_task_id'])

    def backwards(self, orm):
        # Removing M2M table for field wait_on on 'Task'
        db.delete_table('general_task_wait_on')
