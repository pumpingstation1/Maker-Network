...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.privacy_groupsonly'
        db.add_column('general_userprofile', 'privacy_groupsonly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.privacy_groupsonly'
        db.delete_column('general_userprofile', 'privacy_groupsonly')
    ...
    models = {
        ...
        'general.userprofile': {
            ...
            'privacy_groupsonly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
