...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'WorkingGroup', fields ['name']
        db.delete_unique('general_workinggroup', ['name'])

        # Adding unique constraint on 'WorkingGroup', fields ['organization', 'name']
        db.create_unique('general_workinggroup', ['organization_id', 'name'])

    def backwards(self, orm):
        # Removing unique constraint on 'WorkingGroup', fields ['organization', 'name']
        db.delete_unique('general_workinggroup', ['organization_id', 'name'])

        # Adding unique constraint on 'WorkingGroup', fields ['name']
        db.create_unique('general_workinggroup', ['name'])
