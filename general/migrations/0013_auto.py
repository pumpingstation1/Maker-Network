...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('general_task_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm['general.task'], null=False)),
            ('skill', models.ForeignKey(orm['general.skill'], null=False))
        ))
        db.create_unique('general_task_skills', ['task_id', 'skill_id'])

        # Adding M2M table for field resources on 'Task'
        db.create_table('general_task_resources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm['general.task'], null=False)),
            ('resource', models.ForeignKey(orm['general.resource'], null=False))
        ))
        db.create_unique('general_task_resources', ['task_id', 'resource_id'])

    def backwards(self, orm):
        # Removing M2M table for field skills on 'Task'
        db.delete_table('general_task_skills')

        # Removing M2M table for field resources on 'Task'
        db.delete_table('general_task_resources')
    ...
    models = {
        ...
        'general.task': {
            ...
            'resources': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'tasks_using'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['general.Resource']"}),
            'skills': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'tasks_using'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['general.Skill']"}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'ts': ('django.db.models.fields.BigIntegerField', [], {}),
            'wait_on': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'wait_on_rel_+'", 'null': 'True', 'to': "orm['general.Task']"})
        },
        'general.tasklog': {
        ...
        'general.workinggroup': {
            'Meta': {'unique_together': "(('name', 'organization'),)", 'object_name': 'WorkingGroup'},
