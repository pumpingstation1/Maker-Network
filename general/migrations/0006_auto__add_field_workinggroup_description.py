...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkingGroup.description'
        db.add_column('general_workinggroup', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WorkingGroup.description'
        db.delete_column('general_workinggroup', 'description')
